...
var command = __importStar(require("./truckersmp"));
var status_1 = __importDefault(require("./truckersmp/status"));
jest.mock('./truckersmp/status', function () { return ({ __esModule: true, "default": jest.fn() }); });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        interaction = {
                            options: {
                                getSubcommand: function () { return 'status'; }
                            }
                        };
                        return [4 /*yield*/, command.execute(interaction)];
                    case 1:
                        _a.sent();
                        expect(status_1["default"]).toHaveBeenCalledWith(interaction);
                        return [2 /*return*/];
                }
            });
        });
