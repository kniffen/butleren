...
describe('/api/spotify/search', function () {
    var app;
    var fetchSpotifySearchMock = utils_1.fetchSpotifySearch;
    beforeAll(function () {
        app = (0, express_1["default"])();
        app.use('/api/spotify', index_1["default"]);
    });
    describe('GET', function () {
        var URI = '/api/spotify/search?q=query001&type=type001&market=market001&limit=100';
        it('Should respond with an array of search results', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fetchSpotifySearchMock.mockResolvedValue({ foo: 'bar' });
