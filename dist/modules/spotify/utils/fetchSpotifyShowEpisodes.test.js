...
describe('moduled.spotify.utils.fetchSpotifyShowEpisodes()', function () {
    ...
    it('Should return an array of episodes for the show', function () {
        return __awaiter(this, void 0, void 0, function () {
            var results;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchSpotifyShowEpisodes_1.fetchSpotifyShowEpisodes)('foo')];
                    case 1:
                        results = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.spotify.com/v1/shows/foo/episodes/?market=US', {
                            headers: {
    ...
    it('Should use arguments in the URI', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchSpotifyShowEpisodes_1.fetchSpotifyShowEpisodes)('foo', 'bar')];
                    case 1:
                        _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.spotify.com/v1/shows/foo/episodes/?market=bar', expect.anything());
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchSpotifyShowEpisodes_1.fetchSpotifyShowEpisodes)('foo')];
                    case 1:
                        results = _a.sent();
