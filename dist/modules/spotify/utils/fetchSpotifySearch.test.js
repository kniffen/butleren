...
describe('moduled.spotify.utils.fetchSpotifySearch()', function () {
    ...
    var results = { shows: { items: ['foo', 'bar'] } };
    beforeAll(function () {
        var _this = this;
    ...
    it('Should return the search results', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchSpotifySearch_1.fetchSpotifySearch)('foo', 'bar')];
                    case 1:
                        results = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.spotify.com/v1/search?q=foo&type=bar&market=US&limit=5', {
                            headers: {
    ...
    it('Should use arguments in the URI', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchSpotifySearch_1.fetchSpotifySearch)('foo', 'show', 'market001', 999)];
                    case 1:
                        _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.spotify.com/v1/search?q=foo&type=show&market=market001&limit=999', expect.anything());
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchSpotifySearch_1.fetchSpotifySearch)('foo', 'bar')];
                    case 1:
                        results = _a.sent();
