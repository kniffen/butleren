...
var fetchTwitterUserTweets_1 = __importDefault(require("./fetchTwitterUserTweets"));
...
describe('modules.twitter.utils.fetchTwitterUserTweets()', function () {
    ...
    it('Should fetch tweets', function () {
        return __awaiter(this, void 0, void 0, function () {
            var tweets;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitterUserTweets_1["default"])('user001')];
                    case 1:
                        tweets = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitter.com/2/users/user001/tweets?tweet.fields=created_at,author_id,in_reply_to_user_id,referenced_tweets,attachments,entities&exclude=retweets,replies', {
                            headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchTwitterUserTweets_1["default"])('user001')];
                    case 1:
                        result001 = _a.sent();
                        fetchMock.mockResolvedValue({ json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, ({})];
