...
describe('modules.twitter.utils.fetchTwitterToken()', function () {
    ...
    var access_token = 'twitterToken';
    beforeAll(function () {
        fetchMock.mockResolvedValue({
            json: function () { return ({ access_token: access_token }); }
        });
    });
    beforeEach(function () {
        jest.clearAllMocks();
    ...
    it('Should return a new token', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitterToken_1["default"])()];
                    case 1:
                        token = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitter.com/oauth2/token', {
                            method: 'POST',
                            body: 'grant_type=client_credentials',
                            headers: {
                                Authorization: "Basic ".concat(Buffer.from("".concat(process.env.TWITTER_API_KEY, ":").concat(process.env.TWITTER_API_SECRET)).toString('base64')),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchTwitterToken_1["default"])(true)];
                    case 1:
                        token = _a.sent();
