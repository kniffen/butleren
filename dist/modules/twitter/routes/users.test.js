...
describe('/api/twitter/:guild/users', function () {
    var app = null;
    var db = null;
    var URI = '/api/twitter/guild001/users';
    function resetDatabase() {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db.run('DELETE FROM twitterUsers')];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO twitterUsers (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild001', 'twitterUser002', 'channel002'])];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO twitterUsers (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild002', 'twitterUser001', 'channel003'])];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO twitterUsers (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild002', 'twitterUser003', 'channel004'])];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        app.use('/api/twitter', index_js_1["default"]);
                        return [4 /*yield*/, db.migrate()];
                    case 2:
                        _a.sent();
                        fetchTwitterUsers_js_1["default"].mockResolvedValue([
    ...
    describe('GET', function () {
        it('Should respond with an array of twitter users for the guild', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        it('Should handle there being no twitter users for the IDs', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('POST', function () {
        ...
        it('Should respond with a 500 status code if there was an issue adding the twitter user to the database', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res, _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
    ...
    describe('PATCH', function () {
        ...
        it('Should respond with a 404 status code if the entry does not exist in the database', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, supertest_1["default"])(app).patch(URI).send(__assign(__assign({}, body), { id: 'twitterUser999' }))];
                        case 1:
                            res = _b.sent();
                            expect(console.error).not.toHaveBeenCalled();
