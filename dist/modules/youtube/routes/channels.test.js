...
jest.mock('../utils/fetchYouTubeChannels', function () { return ({ __esModule: true, "default": jest.fn() }); });
describe('/api/youtube/:guild/channels', function () {
    var app;
    var db;
    var URI = '/api/youtube/guild001/channels';
    var fetchYouTubeChannelsMock = fetchYouTubeChannels_1["default"];
    function resetDatabase() {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, db.run('DELETE FROM youtubeChannels')];
                    case 1:
                        _a.sent();
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO youtubeChannels (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild001', 'youtubeChannel002', 'channel002'])];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO youtubeChannels (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild002', 'youtubeChannel001', 'channel003'])];
                    case 4:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT INTO youtubeChannels (guildId, id, notificationChannelId) VALUES (?,?,?)', ['guild002', 'youtubeChannel003', 'channel004'])];
                    case 5:
                        _a.sent();
                        return [2 /*return*/];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        app.use('/api/youtube', router_1["default"]);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        jest.clearAllMocks();
                        fetchYouTubeChannelsMock.mockImplementation(function (_a) {
                            var ids = _a.ids;
                            return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_b) {
                                    return [2 /*return*/, ids.map(function (id) { return ({
                                            id: id,
                                            snippet: {
                                                title: "".concat(id, "_title"),
                                                description: "".concat(id, "_description"),
                                                customUrl: 'youtubeChannel001' === id ? "".concat(id, "_custom_url") : undefined
                                            }
                                        }); })];
                                });
                            });
    ...
    describe('GET', function () {
        it('Should respond with an array of channels for the guild', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        it('Should handle there being no channels for the IDs', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe('PATCH', function () {
        ...
        it('Should respond with a 404 status code if the entry does not exist in the database', function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, (0, supertest_1["default"])(app).patch(URI).send(__assign(__assign({}, body), { id: 'youtubeChannel999' }))];
                        case 1:
                            res = _b.sent();
                            expect(console.error).not.toHaveBeenCalled();
