...
describe('fun.commands.dog', function () {
    ...
    it('should contain certain properties', function () {
        expect(dog_1.dogCommand).toEqual({
            data: {
                name: 'dog',
    ...
    it('should post a random dog image', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dog_1.dogCommand.execute(interaction)];
                    case 1:
                        _a.sent();
    ...
    it('should post a fallback dog image if the request failed', function () {
        return __awaiter(this, void 0, void 0, function () {
            var err;
            var _this = this;
            return __generator(this, function (_a) {
