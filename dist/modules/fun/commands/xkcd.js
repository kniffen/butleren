...
var execute = function (interaction) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _b.sent();
                id = (_a = interaction.options.get('id')) === null || _a === void 0 ? void 0 : _a.value;
                return [4 /*yield*/, (0, node_fetch_1["default"])(id ? "https://xkcd.com/".concat(id, "/info.0.json") : 'https://xkcd.com/info.0.json')
