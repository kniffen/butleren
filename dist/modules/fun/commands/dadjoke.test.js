...
describe('fun: commands: dadjoke', function () {
    ...
    it('should contain certain properties', function () {
        expect(dadjoke_1.dadjokeCommand).toEqual({
            data: {
                name: 'dadjoke',
    ...
    it('should post a random dad joke', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, dadjoke_1.dadjokeCommand.execute(interaction)];
                    case 1:
                        _a.sent();
    ...
    it('should post a fallback cat image if the request failed', function () {
        return __awaiter(this, void 0, void 0, function () {
            var err;
            var _this = this;
            return __generator(this, function (_a) {
