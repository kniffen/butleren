...
var execute = function (interaction) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, (0, node_fetch_1["default"])('https://dog.ceo/api/breeds/image/random')
                        .then(function (res) { return res.json(); })
                        .then(function (data) { return interaction.editReply({ files: [data.message] }); })["catch"](function (err) {
                        console.error(err);
