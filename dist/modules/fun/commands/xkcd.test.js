...
describe('fun: commands: xkcd', function () {
    ...
    it('should contain certain properties', function () {
        expect(xkcd_1.xkcdCommand).toEqual({
            data: {
                name: 'xkcd',
    ...
    it('should respond with the latest XKCD comic', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, xkcd_1.xkcdCommand.execute(interaction)];
                    case 1:
                        _a.sent();
    ...
    it('should respond with a specific XKCD comic', function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options.set('id', { value: 'foobar' });
                        return [4 /*yield*/, xkcd_1.xkcdCommand.execute(interaction)];
                    case 1:
                        _a.sent();
                        expect(interaction.deferReply).toHaveBeenCalled();
    ...
    it('should respond with a fallback XKCD comic if one cannot be resolved', function () {
        return __awaiter(this, void 0, void 0, function () {
            var err;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        fetchMock.mockImplementation(function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                            throw err;
                        }); }); });
                        return [4 /*yield*/, xkcd_1.xkcdCommand.execute(interaction)];
                    case 1:
