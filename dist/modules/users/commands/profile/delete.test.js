...
var delete_js_1 = __importDefault(require("./delete.js"));
describe('modules.users.commands.profile.delete', function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, db.run('INSERT OR IGNORE INTO users (id, location) VALUES (?,?)', ['user001', 'location001'])];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, db.run('INSERT OR IGNORE INTO users (id, location) VALUES (?,?)', ['user002', 'location002'])];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should remove a user\'s data from the database', function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, delete_js_1["default"])(interaction)];
                    case 1:
                        _b.sent();
    ...
    it('should handle the user not existing in the database', function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, delete_js_1["default"])(interaction)];
                    case 1:
                        _b.sent();
                        expect(interaction.reply).toHaveBeenCalledWith({
    ...
    it('should handle deleting from the database being rejected', function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
