    ...
    it('Should return a new token', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchToken_1["default"])()];
                    case 1:
                        token = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://id.twitch.tv/oauth2/token?client_id=twitch_client_id&client_secret=twitch_client_secret&grant_type=client_credentials&scope=user:read:email', {
                            method: 'POST'
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (0, fetchTwitchToken_1["default"])(true)];
                    case 1:
                        token = _a.sent();
