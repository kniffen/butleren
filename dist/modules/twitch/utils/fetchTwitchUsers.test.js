...
var fetchTwitchUsers_1 = __importDefault(require("./fetchTwitchUsers"));
...
describe('modules.twitch.utils.fetchTwitchUsers()', function () {
    ...
    it('Should fetch users via ids', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchUsers_1["default"])({ ids: ['user001', 'user002'], usernames: [] })];
                    case 1:
                        streams = _a.sent();
                        expect(console.error).not.toHaveBeenCalled();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitch.tv/helix/users?id=user001&id=user002', {
                            headers: {
    ...
    it('Should fetch users via usernames', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchUsers_1["default"])({ ids: [], usernames: ['username001', 'username002'] })];
                    case 1:
                        streams = _a.sent();
                        expect(console.error).not.toHaveBeenCalled();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitch.tv/helix/users?login=username001&login=username002', {
                            headers: {
                                'Client-Id': 'twitch_client_id',
                                'Authorization': 'Bearer twitchToken'
                            }
    ...
    it('Should handle there being no users', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _b = (_a = results).push;
                        return [4 /*yield*/, (0, fetchTwitchUsers_1["default"])({ ids: ['user001', 'user002'], usernames: [] })];
                    case 1:
                        _b.apply(_a, [_e.sent()]);
                        fetchMock.mockResolvedValue({ json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, ({})];
