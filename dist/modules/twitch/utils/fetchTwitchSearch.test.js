...
var fetchTwitchSearch_1 = __importDefault(require("./fetchTwitchSearch"));
...
describe('modules.twitch.utils.fetchTwitchSearch()', function () {
    ...
    it('Should return an array of search results', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchSearch_1["default"])({ query: 'foo bar' })];
                    case 1:
                        results = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitch.tv/helix/search/channels/?query=foo%20bar', {
                            headers: {
    ...
    it('Should use arguments in the URI', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchSearch_1["default"])({ query: 'foo bar', type: 'channels' })];
                    case 1:
                        results = _a.sent();
    ...
    it('Should handle there being no search results', function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        _b = (_a = results).push;
                        return [4 /*yield*/, (0, fetchTwitchSearch_1["default"])({ query: 'foo bar' })];
                    case 1:
                        _b.apply(_a, [_e.sent()]);
                        fetchMock.mockResolvedValue({ json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, ({})];
