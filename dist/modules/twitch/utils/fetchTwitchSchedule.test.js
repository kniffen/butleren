...
var fetchTwitchSchedule_1 = __importDefault(require("./fetchTwitchSchedule"));
...
describe('modules.twitch.utils.fetchTwitchSchedule()', function () {
    ...
    beforeAll(function () {
        ...
        fetchMock.mockResolvedValue({
            json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                return [2 /*return*/, ({ data: { segments: ['foo', 'bar'] } })];
            }); }); }
        });
    });
    beforeEach(function () {
    ...
    it('Should return an array of scheduled streams', function () {
        return __awaiter(this, void 0, void 0, function () {
            var schedule;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetchTwitchSchedule_1["default"])({ id: 'twitchChannel001' })];
                    case 1:
                        schedule = _a.sent();
                        expect(fetchMock).toHaveBeenCalledWith('https://api.twitch.tv/helix/schedule?broadcaster_id=twitchChannel001', {
                            headers: {
    ...
    it('Should handle there being no scheduled streams', function () {
        return __awaiter(this, void 0, void 0, function () {
            var results, _a, _b, _c, _d, _e, _f;
            var _this = this;
                ...
                switch (_g.label) {
                    case 0:
                        ...
                        fetchMock.mockResolvedValue({ json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                return [2 /*return*/, ({ data: { segments: [] } })];
                            }); }); } });
                        _b = (_a = results).push;
                        return [4 /*yield*/, (0, fetchTwitchSchedule_1["default"])({ id: 'twitchChannel001' })];
                    case 1:
                        _b.apply(_a, [_g.sent()]);
                        fetchMock.mockResolvedValue({ json: function () { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
