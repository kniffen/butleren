...
describe('/api/guilds/:guild/channels', function () {
    var _this = this;
    var URI = '/api/guilds/guild001/channels';
    ...
    beforeAll(function () {
        ...
        channels.set('channel003', { id: 'channel003', name: 'channelname003', type: discord_js_1.ChannelType.GuildAnnouncement });
        // eslint-disable-next-line @typescript-eslint/ban-ts-comment
        // @ts-ignore
        client_1["default"].guilds.fetch.mockRejectedValue('Guild not found');
    });
    beforeEach(function () {
        jest.clearAllMocks();
    });
    describe('GET', function () {
        it('should respond with a 404 status code if the guild could not be found', function () {
        ...
        it('should respond with a list of available text channels', function () {
            return __awaiter(this, void 0, void 0, function () {
                var res;
                return __generator(this, function (_a) {
                    switch (_a.label) {
