...
var onGuildCreate_1 = __importDefault(require("./onGuildCreate"));
...
jest.mock('../../database/addGuildToDatabase', function () { return ({
    __esModule: true,
    "default": jest.fn().mockImplementation(function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
...
describe('discord.eventHandlers.onGuildCreate()', function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        jest.clearAllMocks();
                        return [4 /*yield*/, (0, onGuildCreate_1["default"])(guild)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it('should add guilds to the database', function () {
        expect(addGuildToDatabase_1["default"]).toHaveBeenCalledWith(guild);
    });
    ...
    it('should handle command creation being rejected', function () {
        return __awaiter(this, void 0, void 0, function () {
            var createMock;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        createMock = guild.commands.create;
